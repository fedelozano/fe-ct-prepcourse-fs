...
function tieneTresDigitos(num) {//345
   // Si el número recibido tiene tres dígitos retornar true.
   // Caso contrario, retornar false.
   // Tu código:
   let digitos=num.toString(); //345.toString()-=> "345"
   if (digitos.length === 3){ // 3===3 
...
function doWhile(num) {//10
   ...
   do{
      num = num + 5; //15,20,25,30,35,40,45,50
      i++
   } while (i < 8);
   return num;
}
